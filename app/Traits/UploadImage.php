...
trait UploadImage
{
    ...
    public function getImage(string $name = 'image',string $imageDefault = '/img/no_logo.png') : string // вывод картинки
    {
    ...
    public function getImages($number = 0,string $name = 'images', string $imageDefault = '/img/no_logo.png') : string // вывод картинки
    {
